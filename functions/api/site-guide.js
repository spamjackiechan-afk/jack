...
function welcomeFor(page) {
  if (page === "testing") {
    return "You’re on the testing page. I can explain what a COA can (and can’t) prove, how vendor tiers work on this site, or pull research notes for a named peptide. No dosing, no medical advice.";
  }
  if (page === "suppliers") {
    return "You’re on the suppliers page. I can list who’s on the site, summarize shipping/payment from our supplier notes, or send you to testing tiers and the price list. Catalog facts only — no vendor hype.";
  }
  return "Hi — I can help you find a peptide on this catalog, compare prices, or point you to testing notes and suppliers. Research use only; I don’t give dosing or medical advice.";
}
